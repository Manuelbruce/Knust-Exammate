...
class _CofScienceViewState extends State<CofScienceView> {
  final List<Map<String, dynamic>> _allUsers = [
    {"name": "Computer Science", "courses": ["Introduction to Structured Program Design","Circuit Theory","Discrete Mathematics I","Information Systems", "Introductory Electronics", "Data Structures","Ecommerce", "Programming with C++", "Pure Mathematics", "Web-based Concepts and Development", "Object Oriented Programming with Java", "Communication Skills", "Probability and Statistics",  "Open Source Operating Systems", "Ethical and Legal Implications of Computing", "Linear and Numerical Algebra", "Elements of Economics",  "System Analysis and Design", "Database Concepts and Technologies","Human-Computer Interaction", "Analogue and Digital Electronics", "Assembly Language", "Numerical Methods and Computation", "Programming with Visual Basic", "Mobile Applications", "Survey of Programming Languages", "Introduction to Artificial Intelligence","Computer Architecture", "Computer Graphics", "E-Commerce", "Real-Time and Embedded Systems", "Research Method and IT Project","Literature in English", "Data Communications", "Operating Systems", "Graph Theory and Its Applications", "Introduction to Software Engineering", "Expert Systems", "Computer Networks", "Introduction to Compilers", "Computer Security", "Operations Research","Principles of Management","Financial Accounting"]},
