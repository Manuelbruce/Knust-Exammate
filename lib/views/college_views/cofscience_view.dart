...
class _CofScienceViewState extends State<CofScienceView> {
  final List<Map<String, dynamic>> _allUsers = [
    {"name": "Computer Science", "courses": ["Principles of Management", "Data Structures", "Programming with C++","Information Technology", "Circuit Theory", "Introduction to Structured Program Design", "Discrete Mathematics", "Introductory Pure Mathematics", "Elements of Economics", "Communication Skills", "Introduction to Probability and Statistics", "Introductory Electronics", "Open Source Operating Systems", "Ethical and Legal Implication of Computing", "Linear and Numerical Algebra", "Object Oriented Programming with Java", "System Analysis and Design", "Database Concepts and Technologies", "Literature in English", "Analogue and Digital Electronics", "Programming with Assembly Language", "Numerical Methods and Computation", "Programming with Visual Basic", "Mobile Applications", "Survey of Programming Languages", "Human Computer Interaction", "Introduction to Artificial Intelligence", "Web-based Concepts and Development", "Computer Architecture", "Computer Graphics", "E-Commerce", "Real-time and Embedded Systems", "Research Method and IT Project", "Data Communications", "Operating Systems", "Graph Theory and Its Applications", "Introduction to Software Engineering", "Expert Systems", "Principles of Management", "Computer Networks", "Introduction to Compilers", "Computer Security", "Principles of Management II"]},
